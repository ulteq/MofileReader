...
<title>MofileReader: minimatch</title>
...
<script type="text/javascript">
$(document).ready(function(){initNavTree('md_node_modules_minimatch__r_e_a_d_m_e.html','');});
</script>
<div id="doc-content">
...
<div class="title">minimatch </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p>A minimal matching utility.</p>
<p><a href="http://travis-ci.org/isaacs/minimatch"></a></p>
...
<h2>Usage</h2>
<div class="fragment"><div class="line">var minimatch = require(&quot;minimatch&quot;)</div><div class="line"></div><div class="line">minimatch(&quot;bar.foo&quot;, &quot;*.foo&quot;) // true!</div><div class="line">minimatch(&quot;bar.foo&quot;, &quot;*.bar&quot;) // false!</div><div class="line">minimatch(&quot;bar.foo&quot;, &quot;*.+(bar|foo)&quot;, { debug: true }) // true, and noisy!</div></div><!-- fragment --><h2>Features</h2>
...
<div class="fragment"><div class="line">var Minimatch = require(&quot;minimatch&quot;).Minimatch</div><div class="line">var mm = new Minimatch(pattern, options)</div></div><!-- fragment --><h3>Properties</h3>
<ul>
...
<li><p class="startli"><code>set</code> A 2-dimensional array of regexp or string expressions. Each row in the array corresponds to a brace-expanded pattern. Each item in the row corresponds to a single path-part. For example, the pattern <code>{a,b/c}/d</code> would expand to a set of patterns like: </p><pre class="fragment">  [ [ a, d ]
  , [ b, c, d ] ]
</pre><p class="startli">If a portion of the pattern doesn't have any "magic" in it (that is, it's something like <code>"foo"</code> rather than <code>fo*o?</code>), then it will be left as a string rather than converted to a regular expression.</p>
</li>
...
<div class="fragment"><div class="line">var isJS = minimatch(file, &quot;*.js&quot;, { matchBase: true })</div></div><!-- fragment --><h3>minimatch.filter(pattern, options)</h3>
<p>Returns a function that tests its supplied argument, suitable for use with <code>Array.filter</code>. Example:</p>
<div class="fragment"><div class="line">var javascripts = fileList.filter(minimatch.filter(&quot;*.js&quot;, {matchBase: true}))</div></div><!-- fragment --><h3>minimatch.match(list, pattern, options)</h3>
...
<div class="fragment"><div class="line">var javascripts = minimatch.match(fileList, &quot;*.js&quot;, {matchBase: true}))</div></div><!-- fragment --><h3>minimatch.makeRe(pattern, options)</h3>
