...
<title>MofileReader: ansi-styles [![Build Status](https://travis-ci.org/chalk/ansi-styles.svg?branch=master)](https://travis-ci.org/chalk/ansi-styles)</title>
...
<script type="text/javascript">
$(document).ready(function(){initNavTree('md_node_modules_ansi-styles_readme.html','');});
</script>
<div id="doc-content">
...
<div class="title">ansi-styles [![Build Status](<a href="https://travis-ci.org/chalk/ansi-styles.svg?branch=master">https://travis-ci.org/chalk/ansi-styles.svg?branch=master</a>)](<a href="https://travis-ci.org/chalk/ansi-styles">https://travis-ci.org/chalk/ansi-styles</a>) </div>  </div>
</div><!--header-->
<div class="contents">
...
<h2>Install</h2>
<div class="fragment"><div class="line">$ npm install --save ansi-styles</div></div><!-- fragment --><h2>Usage</h2>
<div class="fragment"><div class="line">var ansi = require(&#39;ansi-styles&#39;);</div><div class="line"></div><div class="line">console.log(ansi.green.open + &#39;Hello world!&#39; + ansi.green.close);</div></div><!-- fragment --><h2>API</h2>
...
<h6>Example</h6>
<div class="fragment"><div class="line">console.log(ansi.colors.green.open);</div></div><!-- fragment --><h2>License</h2>
