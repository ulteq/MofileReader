...
<title>MofileReader: Node.js: fs-extra</title>
...
<script type="text/javascript">
$(document).ready(function(){initNavTree('md_node_modules_fs-extra__r_e_a_d_m_e.html','');});
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><p><code>fs-extra</code> adds file system methods that aren't included in the native <code>fs</code> module and adds promise support to the <code>fs</code> methods. It also uses <a href="https://github.com/isaacs/node-graceful-fs"><code>graceful-fs</code></a> to prevent <code>EMFILE</code> errors. It should be a drop in replacement for <code>fs</code>.</p>
<p><a href="https://www.npmjs.org/package/fs-extra"></a> <a href="https://github.com/jprichardson/node-fs-extra/blob/master/LICENSE"></a> <a href="http://travis-ci.org/jprichardson/node-fs-extra"></a> <a href="https://ci.appveyor.com/project/jprichardson/node-fs-extra/branch/master"></a> <a href="https://www.npmjs.org/package/fs-extra"></a> <a href="https://coveralls.io/github/jprichardson/node-fs-extra"></a> <a href="https://standardjs.com"></a></p>
<h2>Why? </h2>
...
<div class="fragment"><div class="line">const fs = require(&#39;fs&#39;)</div><div class="line">const fse = require(&#39;fs-extra&#39;)</div></div><!-- fragment --><h2>Sync vs Async vs Async/Await </h2>
...
<p>Example:</p>
<div class="fragment"><div class="line">const fs = require(&#39;fs-extra&#39;)</div><div class="line"></div><div class="line">// Async with promises:</div><div class="line">fs.copy(&#39;/tmp/myfile&#39;, &#39;/tmp/mynewfile&#39;)</div><div class="line">  .then(() =&gt; console.log(&#39;success!&#39;))</div><div class="line">  .catch(err =&gt; console.error(err))</div><div class="line"></div><div class="line">// Async with callbacks:</div><div class="line">fs.copy(&#39;/tmp/myfile&#39;, &#39;/tmp/mynewfile&#39;, err =&gt; {</div><div class="line">  if (err) return console.error(err)</div><div class="line">  console.log(&#39;success!&#39;)</div><div class="line">})</div><div class="line"></div><div class="line">// Sync:</div><div class="line">try {</div><div class="line">  fs.copySync(&#39;/tmp/myfile&#39;, &#39;/tmp/mynewfile&#39;)</div><div class="line">  console.log(&#39;success!&#39;)</div><div class="line">} catch (err) {</div><div class="line">  console.error(err)</div><div class="line">}</div><div class="line"></div><div class="line">// Async/Await:</div><div class="line">async function copyFiles () {</div><div class="line">  try {</div><div class="line">    await fs.copy(&#39;/tmp/myfile&#39;, &#39;/tmp/mynewfile&#39;)</div><div class="line">    console.log(&#39;success!&#39;)</div><div class="line">  } catch (err) {</div><div class="line">    console.error(err)</div><div class="line">  }</div><div class="line">}</div><div class="line"></div><div class="line">copyFiles()</div></div><!-- fragment --><h2>Methods </h2>
<h3>Async</h3>
<ul>
<li><a class="el" href="fs-extra_2docs_2copy_8md.html">copy</a></li>
<li><a class="el" href="fs-extra_2docs_2empty_dir_8md.html">emptyDir</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_file_8md.html">ensureFile</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_dir_8md.html">ensureDir</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_link_8md.html">ensureLink</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_symlink_8md.html">ensureSymlink</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_dir_8md.html">mkdirp</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_dir_8md.html">mkdirs</a></li>
<li><a class="el" href="fs-extra_2docs_2move_8md.html">move</a></li>
<li><a class="el" href="fs-extra_2docs_2output_file_8md.html">outputFile</a></li>
<li><a class="el" href="fs-extra_2docs_2output_json_8md.html">outputJson</a></li>
<li><a class="el" href="path_exists_8md.html">pathExists</a></li>
<li><a class="el" href="fs-extra_2docs_2read_json_8md.html">readJson</a></li>
<li><a class="el" href="fs-extra_2docs_2remove_8md.html">remove</a></li>
<li><a class="el" href="fs-extra_2docs_2write_json_8md.html">writeJson</a></li>
</ul>
<h3>Sync</h3>
<ul>
<li><a class="el" href="fs-extra_2docs_2copy-sync_8md.html">copySync</a></li>
<li><a class="el" href="fs-extra_2docs_2empty_dir-sync_8md.html">emptyDirSync</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_file-sync_8md.html">ensureFileSync</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_dir-sync_8md.html">ensureDirSync</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_link-sync_8md.html">ensureLinkSync</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_symlink-sync_8md.html">ensureSymlinkSync</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_dir-sync_8md.html">mkdirpSync</a></li>
<li><a class="el" href="fs-extra_2docs_2ensure_dir-sync_8md.html">mkdirsSync</a></li>
<li><a class="el" href="fs-extra_2docs_2move-sync_8md.html">moveSync</a></li>
<li><a class="el" href="fs-extra_2docs_2output_file-sync_8md.html">outputFileSync</a></li>
<li><a class="el" href="fs-extra_2docs_2output_json-sync_8md.html">outputJsonSync</a></li>
<li><a class="el" href="path_exists-sync_8md.html">pathExistsSync</a></li>
<li><a class="el" href="fs-extra_2docs_2read_json-sync_8md.html">readJsonSync</a></li>
<li><a class="el" href="fs-extra_2docs_2remove-sync_8md.html">removeSync</a></li>
<li><a class="el" href="fs-extra_2docs_2write_json-sync_8md.html">writeJsonSync</a></li>
</ul>
<p><b>NOTE:</b> You can still use the native Node.js methods. They are promisified and copied over to <code>fs-extra</code>. See <a class="el" href="fs-read-write_8md.html">notes on `fs.read()` &amp; `fs.write()`</a></p>
...
<h3>Obtain Filesystem (Devices, Partitions) Information</h3>
